...
public class SignInController extends GeneralController implements Initializable 
{
    ...
    public void finshSignIn(ActionEvent event) throws IOException{   
        ...
        loader.setLocation(getClass().getClassLoader().getResource("Client/MainRoom/MainRoom.fxml"));
    ...
    {
        Parent signUpView =  FXMLLoader.load(getClass().getClassLoader().getResource("Client/StartPage/SignUp.fxml"));
